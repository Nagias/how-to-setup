...
import BlogDetailModal from './components/blog/BlogDetailModal'; // Keep for now or remove if confirmed unused
...
const AppContent = () => {
    const { currentView, selectedSetup, selectedBlog } = useApp();
    ...
    return (
        <div className="app">
            ...
            {/* {selectedBlog && <BlogDetailModal />} - Replaced by page view */}
            <AuthModal />
            <ProfileModal />
            <NewsletterModal />
            <CollectionsModal />
            ...
            <footer className="footer">
                ...
                <div className="footer-bottom">
                    <div className="container">
                        <p>&copy; 2026 DeskHub. Tất cả quyền được bảo lưu. Được xây dựng với ❤️ bởi Google Antigravity.</p>
                    </div>
                </div>
            </footer>
        </div>
